...
In order to create a training set of tiles for image-recognition, I programmed a robot to take approximately 30 screenshots of the initial interface. For consistency these were taken in full-screen mode, on the linux virtual machine on my Asus Chromebook.
