...
Perhaps most closely related to the original intention of the undertaking is the production of *insight.* Learning how to play the games available on the platform (or in principle not necessarily) at scale, may uncover patterns which are not necessarily available through the application of heuristic methods and thus provide insight into the games available and by extension their users. This in turn will allow for better targeting of adds, which is one of the suggested income-streams for the company.

### Generative Gatai

Gato furthermore aspires to apply *generative AI* in order to create games customized to each users preferences. A deep understanding of existing games is a fundamental input to any generative algorithm we produce for this purpose.
...
This application relates to multiplayer-games. WIth knowledge of how to play the game in question, Gatai can take on or several seats in a multiplayer game, and thus make the experience more interesting for the user. If, for example, I have the urge to play Bridge at 4am in the morining in my time-zone, and I can only find two more insomniacs to join me, I would be able to call on Gatai to fill the fourth chair.
