...
Gato furthermore aspires to apply *generative AI* in order to create games customized to each user's preferences. A deep understanding of existing games is a fundamental input to any generative algorithm we produce for this purpose.
