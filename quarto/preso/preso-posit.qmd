...
Using *selenium* with a *Chrome* Browser

-   I used python

-   An R package {RSelenium} is also available (didn't work on my hardware)

## Interacting with the GUI

![](images/mermaid-diagram-2024-08-07-162155.png)
...
$$
P(Y) \sim \color{red}\blacksquare+\color{green}\blacksquare+\color{blue}\blacksquare +  ... + \epsilon
$$
