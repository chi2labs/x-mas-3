...
We then applied the Q-learning algorithm [@watkins1992q] implemented in the open source _ReinforcementLearning_ package [@ReinforcementLearning], with the *standard default* parameters ($\alpha=.1,\gamma=.1, \epsilon=.1$).
...
#| layout-ncol: 3
#| fig-cap: Board 263
#| fig-subcap: ["Board","Scoring Moves","Strongest Moves"]
#| fig-asp: 1
#| fig-width: 3
#| echo: false
p <- plot(S[[263]])
