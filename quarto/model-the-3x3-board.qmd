...
We then using the Q-learning algorithm implemented in the opensource _ReinforcementLearning_ package [@ReinforcementLearning], with the *standard default* parameters ($\alpha=.1,\gamma=.1, \epsilon=.1$).
