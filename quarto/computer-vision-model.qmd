...
*Selenium* is our go-to solution when browser automation is required. Given the prior implementation of Gatai, it made sense to interact with *Selenium* using the package available on CRAN [@RSelenium].
...
::: {#fig-example-tiles layout-ncol=4}
